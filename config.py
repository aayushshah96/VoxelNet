...
# for dataset dir
__C.DATA_DIR = 'data/training/velodyne/'
__C.CALIB_DIR = 'data/data_object_calib/training/calib/'
...
__C.PROPOSAL3D_Z_MIN = -3.0#-2.3  # -2.52
__C.PROPOSAL3D_Z_MAX = 1.0#1.5  # -1.02
